...
if __name__ == "__main__":
    async def main():
        ...
        result = await agent.run(
            table_name="695d65147d562e7336976597_tbl",
            table_schema={
            "schema": [
                {
                    "column_name": "Name",
                    ...
                    "description": "The name of the company or entity."
                },
                {
                    "column_name": "Region",
                    "inferred_type": "string",
                    ...
                    "description": "The geographical region where the company is located."
                },
                {
                    "column_name": "Type",
                    "inferred_type": "string",
                ...
                },
                {
                    ...
                    "description": "The amount spent monthly by the company."
                },
                {
                    "column_name": "Vendors",
                    "inferred_type": "integer",
            ...
            user_question="Which are the regions available in table 695d65147d562e7336976597_tbl?",
        )
